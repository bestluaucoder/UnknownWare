...
namespace offsets {
    ...
    inline constexpr uintptr_t PhysicsSenderMaxBandwidthBps = 0x78656d8;
    ...
    inline constexpr uintptr_t PlatformStatePointer = 0x878813d2;
...
} // end namespace offsets

// ─── Compatibility shims — maps old nested namespaces to the new flat layout ──
// All engine .cpp files use offset::camera::Position etc.; these aliases
// make them resolve to offset::offsets::CameraPos etc. without changing any
...
namespace workspace {
    static constexpr uintptr_t world = offsets::World;
}
namespace world {
...
namespace mouseservice {
    ...
    static constexpr uintptr_t InputObject2  = offsets::InputObject;  // same in new layout
...
namespace silent {
    static constexpr uintptr_t FramePositionOffsetX = 0x0;  // write X into GuiSize.X
    static constexpr uintptr_t FramePositionOffsetY = 0x8;  // write Y into GuiSize.Y
}
namespace animation {
    static constexpr uintptr_t Animation   = offsets::CFrame;
...
namespace animator {
    static constexpr uintptr_t ActiveAnimations = offsets::ActiveAnimations;
}
namespace task {
...
namespace physics_sender {
    // PhysicsSenderMaxBandwidthBps — absolute address, not an offset from instance
    // Use drive->modulebase() + this value
